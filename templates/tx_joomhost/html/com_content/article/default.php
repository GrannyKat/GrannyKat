	...
	<?php if(!$this->print) : ?>
		<div class="article-footer-wrap">
			<div class="article-footer-top">
				...
				<?php echo JLayoutHelper::render('joomla.content.social_share.share', $this->item); //Social Share ?>
			</div>
			<?php echo JLayoutHelper::render('joomla.content.comments.comments', $this->item); //Comment ?>
		</div>
	<?php endif; ?>
