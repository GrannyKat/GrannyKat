...
<p class="text-center credit-text <?php echo ( $this->getParam('tx_credit', 1) ? 'text-muted' : 'hide' ) ?>">
	<a class="text-muted" href="https://www.themexpert.com/joomla-templates/joomhost" title="Joomla Template" target="_blank" <?php echo method_exists('T3', 'isHome') && T3::isHome() ? '' : 'rel="nofollow"' ?>>Joomla Template</a> by <a href="https://www.themexpert.com/" target="_blank">ThemeXpert</a>
</p>
