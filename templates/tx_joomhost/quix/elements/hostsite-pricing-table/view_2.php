  ...
  <div class="tx-table-footer">
    <a class="qx-btn qx-element-<?php echo $field['btntype']?> <?php echo $field['btnstyle']?> btn-pricing" href="<?php echo $field['button']['url'] ?>" <?php echo ( $field['button']['target'] ) ? ' target="_blank"' : '' ?>><?php echo $field['button']['text'] ?></a>
  </div><!-- /.table-footer -->
